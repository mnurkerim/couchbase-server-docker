...
couchbase-cli bucket-create -c localhost:8091 -u Administrator -p password --bucket=housekeepingtitles --bucket-type=couchbase --bucket-port=11222 --bucket-ramsize=200 --bucket-replica=1
